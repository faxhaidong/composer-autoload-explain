...
class ClassLoader
{
    ...
    public function findFile($class)
    {
        ...
        // 如果开启仅依赖classMap加载 || 已经查找过且未找到$calss
        if ($this->classMapAuthoritative || isset($this->missingClasses[$class])) {
            return false;
        }
        
        //检查是否已经存在缓存中，由于是多进程见数据共享，所以只要有其他类曾经找过，就无需再次查找
    ...
    private function findFileWithExtension($class, $ext)
    {
        ...
        // PSR-0 lookup
        // 如果是符合psr0规则的，则替换_为/,以便使用psr0加载规范进行处理
